...
const mesh = pagesData[0];

const Mesh = () => {
  return (
    <section className='relative w-full min-h-screen h-full bg-gray-100 '>
        <div className='relative w-full h-3/4 overflow-hidden  '>
            <img src="/images/meshs-image.png" alt="" className='w-full h-screen object-cover ' />
        ...
        <div className='absolute top-52 xl:top-[15vh] xl:left-20'>
            <Card className='w-[50vh] xl:w-[65vh] h-full shadow-none p-7 bg-transparent rounded-3xl text-white border-none '>
                <CardHeader>
                    <CardTitle>
                        <h1 className='text-2xl md:text-6xl font-noto-bold'>{mesh.title}</h1>
                    </CardTitle>
                </CardHeader>
                <CardContent>
        ...
        <Details detail={mesh.detail} />
        <div className='py-5 xl:py-20' />
        <h1 className='font-noto-bold text-2xl md:text-6xl text-center pb-5'>Usable</h1>
        <Details detail={mesh.usable} />


        <BottomImage bottomImage={mesh.bottomImage} example={mesh.example} />
    </section>
  )
}

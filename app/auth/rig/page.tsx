...
const rig = pagesData[3];

const Rig = () => {
  return (
    <section className='relative w-full min-h-screen h-full bg-gray-100 '>
        <div className='relative w-full h-3/4 overflow-hidden  '>
            <img src={rig.mainImage} alt="" className='w-full h-screen object-cover' />
        ...
        <div className='absolute top-52 xl:top-[15vh] xl:left-20'>
            <Card className='w-[50vh] xl:w-[65vh] h-full shadow-none p-7  md:pt-42 bg-transparent rounded-3xl text-white border-none '>
                <CardHeader>
                    <CardTitle>
                        <h1 className='text-2xl md:text-6xl font-noto-bold'>{rig.title}</h1>
                    </CardTitle>
                </CardHeader>
                <CardContent>
        ...
        <Details detail={rig.detail} />
        <div className='py-5 xl:py-20' />
        <h1 className='font-noto-bold text-2xl md:text-6xl text-center pb-5'>Usable</h1>
        <Details detail={rig.usable} />


        <BottomImage bottomImage={rig.bottomImage} example={rig.example} />
    </section>
  )
}
